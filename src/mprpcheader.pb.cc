...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mprpcheader_2eproto = {
  false, false, 109, descriptor_table_protodef_mprpcheader_2eproto, "mprpcheader.proto", 
  ...
  file_level_metadata_mprpcheader_2eproto, file_level_enum_descriptors_mprpcheader_2eproto, file_level_service_descriptors_mprpcheader_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_mprpcheader_2eproto_getter() {
  return &descriptor_table_mprpcheader_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_mprpcheader_2eproto(&descriptor_table_mprpcheader_2eproto);
namespace mprpc {
